...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card text-white mb-3" style="background-color:#883988;cursor:pointer;" id="informacion_panel">
                <div class="card-body">
                    <h4 align="center"><i class="fas fa-user-friends"></i> Informacion</h4>
                </div>
            </div>
        </div>
...
$("#informacion_panel").click(function() {
    let url = "empleados/show";
    $(location).attr('href', url);
});
</script>
@endsection