            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="5" align="right"><b>Impuesto</b></td>
        ...
        <div class="col-sm-12 col-md-12 col-xl-7">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row justify-content-center">
                        <label class="col-sm-3">Numero Comprobante</label>
                        <div class="col-sm-6">
                            <input type="text" style="text-align:center;" class="form-control"
                                value="{{$pedido->numero_comprobante}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row justify-content-center">
                ...
                <div class="card-footer mb-3">
                    <div class="row justify-content-md-center">
                        <div class="col-sm-3">
                            <a href="{{route('trabajador.pedidos.index')}}" class="btn btn-danger btn-block">Volver</a>
                        </div>
                    </div>
                </div>
            </div>
